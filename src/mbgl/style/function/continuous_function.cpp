...
template <typename T>
T ContinuousFunction<T>::evaluate(float, const GeometryTileFeature& feature) const {
...
template class ContinuousFunction<float>;
template class ContinuousFunction<Color>;
