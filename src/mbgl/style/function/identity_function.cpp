...
template <>
float IdentityFunction<float>::evaluate(float, const GeometryTileFeature& feature) const {
...
template <>
Color IdentityFunction<Color>::evaluate(float, const GeometryTileFeature& feature) const {
    optional<Value> v = feature.getValue(property);
